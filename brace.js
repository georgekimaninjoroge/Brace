/*!
 * Brace v1.0.0
 * Essential web infrastructure for African SMEs — one script tag.
 * https://github.com/georgekimaninjoroge/brace
 * MIT License
 */
(function (window, document) {
  ...
  function initSpeed() {
    ...
    if ('IntersectionObserver' in window) {
      ...
      // Also lazy-load native images without loading="lazy"
    ...
    // Defer render-blocking scripts that aren't already deferred
  ...
  function initGA() {
    ...
    // Load only after user interaction to not slow initial paint
    function loadGA() {
  ...
  /* ─── MODULE: CONTACT FORM AUTO-ENHANCE ─────────────────────── */
  ...
  /* ─── MODULE: 404 / BROKEN LINK DETECTOR (DEV HELPER) ───────── */
